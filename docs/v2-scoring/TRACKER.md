...
| V2-F8a | Fabricated streaming chunk types | 3/7 | -15 to -50 pts | Prompt: add raw-string streaming constraint | **NEW** |
...
**Priority:** V2-F8a (chunk types, 3/7, clear prompt fix) > V2-F7 (missing files, 2/7) > V2-F1 (parse, 3/7) > V2-F6 (mismatch, 1/7)
