...
| **81a-e** | **04-07** | **+ F3 leak fix (skip F3 for surgical outputs)** | **12-16** | **—** | **7.4** | **5.6** | **4.6** | **5.0** | **4.4** | **7.0** | **34.0 avg** | **5/5 plans. build_abstain_message: 0/27 (fixed). But 22% F10 fabrications remain — corrector was REVERTED in bisect. check_artifact misses self._xxx.method() chained calls. Score bottleneck is F10.** |
