...
| ranking_explanation | fitz-sage | Python | 68.85 / 56.5 | 96.9 / 65.2 | 5 after calibrated build-new prompt (2026-04-18/19). A2-ceiling bound (5/5 A2) — A1 requires rubric awareness not structural choice. New-module question is neither helpful nor harmful on this task |
| hoppscotch_sharing | hoppscotch | TypeScript | 71.86 / 47.5 | 73.9 / 80.0 | 5 after calibrated build-new prompt + decision_text_map threading (2026-04-18/19). All 5 plans A1 ("Dedicated CollectionShare Module"), 4/5 P1 schema. Aggressive-fix peak 78.7/95.0; calibration gave back 15 T2 points on service-layer fidelity but preserved the A1 architectural win. +33 T2 over the baseline is the decisive cross-language generality proof |
