...
| ranking_explanation | fitz-sage | Python | 68.85 / 56.5 | 98.0 / 74.5 | 5 after rubric injection (2026-04-19). Rubric codifies taxonomy A1 expectations (preserve base_score/strategy_weight/entity_bonus/keyword_boost, pre_rerank_score, retrieval_method). Engine 5/5 E1, synthesizer 5/5 S1, reranker 2/5 RR1 (first time ever). Architecture still 5/5 A2 because K1 (full breakdown vs composite-only) needs stronger rubric adherence on the ranker side. Prior: 98.7/65.2 without rubric |
