...
| ranking_explanation | fitz-sage | Python | 68.85 / 56.5 | 98.7 / 65.2 | 5 after calibrated build-new prompt (2026-04-18/19). A2-ceiling bound (5/5 A2) — A1 requires rubric awareness not structural choice. New-module question is neither helpful nor harmful on this task. T1 reflects post-language-aware-scorer value (+1.8 from broader stub detection) |
